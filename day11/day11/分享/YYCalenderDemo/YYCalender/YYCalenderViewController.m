...
-(void)setNavigationBar
{
    ...
    UIView *headerView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, size.width, 64)];
    UILabel *tilteL = [[UILabel alloc]initWithFrame:CGRectMake(0, 25, size.width, 30)];
    tilteL.textAlignment = NSTextAlignmentCenter;
    tilteL.textColor = [UIColor redColor];
    tilteL.text = @"选择日期";
    tilteL.font = [UIFont boldSystemFontOfSize:20];
    [headerView addSubview:tilteL];
    ...
    for (NSInteger i = 0; i < 7; i++)
    {
        ...
        [headerView addSubview:dayOfTheWeekLabel];
    }
...
- (void)viewDidLoad
{
    ...
    table = [[UITableView alloc]initWithFrame:CGRectMake(0, 70, size.width, size.height - 70) style:UITableViewStylePlain];
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!cell) {
        ...
        CGSize size = [UIScreen mainScreen].bounds.size;
        YYCalenderCell *calendarCell = [[YYCalenderCell alloc]initWithFrame:CGRectMake(0, 0, size.width - 10, 350) year:2014 month:1];
...
{
    CGSize size = [UIScreen mainScreen].bounds.size;
    UIView *headerView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, size.width, 23)];
    headerView.backgroundColor = secondHeaderColor;
    ...
    bottomLine.frame = CGRectMake(0, 22.5, size.width, 0.5);
    bottomLine.backgroundColor = DayCellLineColor;
    [headerView addSubview:bottomLine];
    UILabel *titleL = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, size.width, 23)];
