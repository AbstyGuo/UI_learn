...
{
  IBOutlet  UIImageView *_iconImageView;//用来显示图标
  IBOutlet  UILabel *_titleLabel;//用于显示书的名字
  IBOutlet  UILabel *_detailLabel;//用于显示详细信息
  IBOutlet  UILabel *_priceLabel;//用于显示价格
}
