...
-(UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section
{
    ...
    UIView *footer = [tableView dequeueReusableHeaderFooterViewWithIdentifier:footerID];
    
    if (footer == nil) {
        //创建新的尾视图
        footer = [[UIView alloc]initWithFrame:CGRectMake(0, 0, tableView.frame.size.width, 40)];
        //设置背景颜色
    ...
    UILabel *label = (id)[footer viewWithTag:10];
    label.text = [NSString stringWithFormat:@"第%ld组尾视图",section];
    return footer;
}
